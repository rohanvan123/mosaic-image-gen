...
TEST_CASE("KDTree constructor", "[weight=1][part=1]") {
...
TEST_CASE("KDTree::findNearestNeighbor", "[weight=1][part=1]") {
...
TEST_CASE("KDTree::findNearestNeighbor (2D)", "[weight=1][part=1]") {
  double coords[6][2] = {
    {-15, 7}, {6, 7}, {-13, -1},
    {-5, 0}, {14, -3}, {14, 2}
  };
...
TEST_CASE("KDTree::findNearestNeighbor (3D)", "[weight=1][part=1]") {
